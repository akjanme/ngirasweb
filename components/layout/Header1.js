                    ...
                    <div className="inner-container">
                        <div className="top-left">
                            <ul className="list-style-one">
                                <li><i className="fa fa-envelope" /> <Link href="mailto:needhelp@company.com">NgirasTechnologies@outlook.com</Link></li>
                                <li><i className="fa fa-map-marker" />GONER ROAD ,Jaipur, Rajasthan </li>
                            </ul>
                        </div>
                ...
                <div className="header-lower">
                    <div className="main-box">
                        <div className="logo-box">
                            <div className="logo"><Link href="/"><Image src={LogoWhite} title='Ngiras' /></Link></div>
                        </div>
                        <div className="nav-outer">
                            ...
                            <div className="outer-box">
                                ...
                                <Link href="tel:+92(8800)9806" className="info-btn">
                                    ...
                                    <small>Call Anytime</small><br /> + 91 ( 9887 ) 111155
                                </Link>
                ...
                <div className="mobile-menu">
                    ...
                    <nav className="menu-box">
                        <div className="upper-box">
                            <div className="nav-logo"><Link href="/"><Image src={LogoWhite} title='Ngiras' /></Link></div>
                        ...
                        <ul className="contact-list-one">
                            <li>
                                <div className="contact-info-box">
                                    ...
                                    <Link href="tel:+92880098670">+91 (9887) - 111155</Link>
                                </div>
                            </li>
                            <li>
                                <div className="contact-info-box">
                                    ...
                                    <Link href="mailto:help@company.com">NgirasTechnologies@gmail.com</Link>
                                </div>
                            </li>
                            <li>
                                <div className="contact-info-box">
